...
const Third = () => {
  ...
  return (
    <div>
      <a href="https://www.behance.net/gallery/197152737/Notch" target="blank">
        <img
          src={thirdWork}
      ...
      <div className="flex sm:-ml-6">
        ...
        <div>
          ...
          <div className="max-w-full sm:w-[325px] text-white text-lg font-medium leading-[25px] ml-2 mt-4">
            Earn rewards for hitting gym milestones! Stay motivated, reach your
            goals with the Notch app.
          </div>
        </div>
      </div>
    </div>
