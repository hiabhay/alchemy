  ...
  return (
    <Section>
      <div className="relative mt-28">
        <div className="relative left-12 w-[80%] sm:left-4 sm:w-[95%]">
        ...
        <div className="mt-16">
          <div className="flex sm:flex-col">
            <div className="relative left-12 w-[400px] sm:w-auto sm:mr-6 sm:left-4">
        ...
        <div className="mt-20 sm:bg-indigo-100 sm:pb-16 sm:pt-10">
          <div className="flex sm:flex-col">
            ...
            <div className="relative mt-4 w-[500px] sm:w-auto sm:mr-6 left-[20%] top-4 sm:left-4">
        ...
        <div className="mt-20">
          <div className="flex sm:flex-col">
            ...
            <div className="relative mt-4 w-[500px] sm:w-auto sm:left-4 sm:mr-6 left-[20%] top-4">
